<template>
  <div>
      ...
      <el-row :gutter="20">
        <el-col :span="7">
          <el-input v-model="queryInfo.query" placeholder="请输入内容" clearable @clear="getRoleList">
            <i slot="append" class="el-icon-search" @click="getRoleList"></i>
          </el-input>
        </el-col>
        <el-col :span="4">
      ...
      <el-table :data="roleList" border stripe>
        ...
        <el-table-column label="操作" width="200px">
          <template slot-scope="scope">
            ...
            <el-button type="danger" size="mini" icon="el-icon-delete" @click="delRole(scope.row.id)"></el-button>
            <el-tooltip class="item" effect="dark" content="分配角色" placement="top" :enterable="false">
              <el-button type="warning" size="mini" icon="el-icon-setting" @click="showRightDialog(scope.row)">
              </el-button>
            </el-tooltip>
          </template>
        </el-table-column>
    ...
    <el-dialog title="分配权限" :visible.sync="setRightDialogVisible" width="50%" @close="setRightDialogClosed">
      <!-- 树形控件 -->
      <el-tree :data="rightList" :props="treeProps" node-key="id" show-checkbox default-expand-all
        :default-checked-keys="defkeys" ref="rightListRef"></el-tree>
...
export default {
  ...
  methods: {
    ...
    async showEditDialog(roleId){
      ...
      if(res.meta.status != 200){
        return this.$message.error('角色不存在')
      }
